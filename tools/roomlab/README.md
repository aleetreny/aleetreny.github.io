...
| `diggings.html` | **The six diggings**, as 1:1 traces of three of the artist's own makeshift rooms — 7.8 %, 5.5 % and 8.9 % of pixels differing, the closest in the habitat. Two diggings sharing a reference differ only in their lamp. |
