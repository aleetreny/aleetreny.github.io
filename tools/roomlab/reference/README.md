...
| `makeshift-two-rooms.png` | 3× | 245 × 181 | 7.7 × 5.7 | **The Diggings — GEOMETRY ONLY. NOT TRACEABLE.** Its furniture matches nothing above 0.766 at ×0.5, ×1 or ×2, and its wall band `#c0b8b2`, brick `#f2eae4` and floor `#a8a09a` exist in no sheet we own. `trace.py` reports its band pieces at 1.000 anyway — NCC scores shape, not colour. What *is* readable is its geometry: a notched outline, two chambers sharing a spur with a gap in it, and a doorway one 32 px tile wide. |
| `makeshift-two-rooms-b.jpg` | 4× | 181 × 187 | 5.7 × 5.8 | **The Diggings — geometry only**, as above. Rectangle x 4..175, y 4..172, partition at x 71..76, doorway x 74..105. |
| `makeshift-bedsit.jpg` | 4× | 179 × 217 | 5.6 × 6.8 | **The Diggings — geometry only**, as above. Rectangle x 19..158, y 23..194, doorway x 74..105 — the same doorway, in the same place, in all three. |
