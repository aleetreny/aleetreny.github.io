...
export const CARDS = [
  ...
  },
  {
    ...
    title: {"es": "Lo que ha pasado por aquí", "en": "What has been through here"},
    note: {"es": "Una barra por año, contando todo lo que hay en este tablero. 2026 sigue abierto.", "en": "One bar per year, counting everything on this board. 2026 is still open."},
    plotKind: "bars",
    series: [2, 2, 4, 4, 5, 23, 13],
    axis: [{"es": "entradas", "en": "entries"}, "2020 → 2026"],
    fastener: "clip",
  },
  {
    id: "stamp-py",
  ...
  },
  {
    ...
    title: {"es": "MSc en Ciencia de Datos y ML", "en": "MSc in Data Science and ML"},
    from: "MAD",
    to: "LON",
    when: "Sep 2026",
    seat: "26A",
  ...
  },
  {
    ...
    w: 300,
    fastener: "tape",
    lines: ["$ whoami", "alejandro", "$ cat plan.txt", {"es": "seguir haciéndole preguntas a los datos", "en": "keep asking the data questions"}],
  },
  {
    id: "scrap-arrow",
    type: "scrap",
