...
export function GroupOverflowPanel({ groupId, label, entries, onOpen, onClose }: GroupOverflowPanelProps) {
  ...
  return (
    <div className="overlay" role="presentation">
      ...
      <div className="panel panel--theme" role="dialog" aria-modal="true" aria-label={`Todos los dossiers de ${label}`}>
        <div className="panel__eyebrow">{label}</div>
        <div className="panel__title">All {items.length} dossiers</div>
