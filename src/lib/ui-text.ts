...
const CATALOGUE: Record<string, Entry> = {
  ...
  'card.frameZoom': { es: 'ampliar', en: 'zoom' },
  'card.frameMove': { es: 'mover', en: 'move' },
  'card.frameUp': { es: 'Mover imagen arriba', en: 'Move image up' },
  'card.frameLeft': { es: 'Mover imagen a la izquierda', en: 'Move image left' },
  'card.frameRight': { es: 'Mover imagen a la derecha', en: 'Move image right' },
  'card.frameDown': { es: 'Mover imagen abajo', en: 'Move image down' },
  'card.frameReset': { es: 'restablecer', en: 'reset' },
