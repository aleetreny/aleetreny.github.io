...
const CATALOGUE: Record<string, Entry> = {
  ...
  'world.uv.gag.fieldManual': { es: 'MANUAL DE CAMPO', en: 'FIELD MANUAL' },
  'world.uv.gag.normal': { es: 'sujeto aparentemente normal', en: 'apparently normal subject' },
  'world.uv.gag.missions': { es: 'misiones pagadas', en: 'paid missions' },
  'world.uv.gag.plotTwist': { es: 'plot twist académico', en: 'academic plot twist' },
  'world.uv.gag.lookCloser': { es: 'sí hay, mira bien', en: 'there is — look closer' },
  'world.uv.gag.machine': { es: 'EN MI MÁQUINA ✓', en: 'WORKS ON MY MACHINE ✓' },
  'world.uv.gag.criteria': { es: 'criterio de selección: ninguno', en: 'selection criteria: none' },
  'world.uv.gag.mangoFunding': { es: 'MANGO-FUNDING', en: 'MANGO-FUNDED' },
  'world.uv.gag.linkedin': { es: 'sin hacer post de LinkedIn', en: 'without a LinkedIn post' },
  'world.uv.gag.mango': { es: 'MANGO > TODO', en: 'MANGO > EVERYTHING' },
  'world.uv.gag.peerReviewed': { es: 'peer reviewed-ish', en: 'peer reviewed-ish' },
  'world.uv.gag.noSlides': { es: 'café sin PowerPoint', en: 'coffee, no PowerPoint' },
