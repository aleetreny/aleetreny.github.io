...
const CATALOGUE: Record<string, Entry> = {
  ...
  'inv.hint': {
    es: 'Añade un artículo a cualquier cajón, o mándalo a una papelera recuperable. Su texto y sus fotos se editan en la propia página.',
    en: 'Add a new card to any drawer, or send one to the recoverable trash. Edit its text and photos inline on the board.',
  },
