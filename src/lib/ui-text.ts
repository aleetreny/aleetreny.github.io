...
const CATALOGUE: Record<string, Entry> = {
  ...
  'owner.addPlot': { es: 'gráfica', en: 'plot' },
  'owner.addStamp': { es: 'sello', en: 'stamp' },
  'owner.addTicket': { es: 'billete', en: 'ticket' },
  'owner.addTerminal': { es: 'terminal', en: 'terminal' },
  ...
  'cardmenu.plotKind': { es: 'tipo de gráfica', en: 'plot type' },
  ...
  'card.plotY': { es: 'eje y', en: 'y axis' },
  'card.plotX': { es: 'eje x', en: 'x axis' },
  'card.plotSeries': { es: 'valores, separados por comas', en: 'values, comma separated' },
  'card.stampDenom': { es: 'país · año', en: 'country · year' },
  'card.stampMark': { es: 'matasellos', en: 'postmark' },
  'card.ticketFrom': { es: 'desde', en: 'from' },
  'card.ticketTo': { es: 'hasta', en: 'to' },
  'card.ticketWhen': { es: 'fecha', en: 'date' },
  'card.ticketSeat': { es: 'asiento', en: 'seat' },
  'card.termLines': { es: 'líneas de consola', en: 'console lines' },
